import { initializeApp } from "https://www.gstatic.com/firebasejs/11.9.0/firebase-app.js";
  ...
  document.getElementById('form-pendaftaran').addEventListener('submit', async function(e) {
    ...
    const data = {
      ...
      status_tempat_tinggal: escapeInput(form.status_tempat_tinggal?.value || ''),
      jumlah_keluarga: escapeInput(form.jumlah_keluarga?.value || ''),
      ...
      alamat_pekerjaan_pasangan: escapeInput(form.alamat_pekerjaan_pasangan?.value || ''),
